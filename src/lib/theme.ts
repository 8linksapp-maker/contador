...
import contabil from '../data/themes/contabil.json';
...
export const PRESETS: Record<string, ThemePreset> = { dental, harmonizacao, vidro, contabil };
...
export function resolveTheme(): { vars: Record<string, string>; preset: ThemePreset } {
  const preset = PRESETS[themeConfig.preset] ?? PRESETS.contabil;
